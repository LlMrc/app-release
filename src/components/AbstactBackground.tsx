...
const AbstractBackground: React.FC = () => {
    ...
    return (
        <div className='flex flex-col justify-between items-center   w-full   md:my-12 '>
            <div className="flex flex-col  items-center justify-center  md:my-20   md:w-2/3 p-2 md:p-0">

                <h2 className='font-semibold text-xl  md:text-4xl mb-4 truncate'>Why Combine Reading with Music?</h2>
            ...
            <div className='bg-gray-200 h-56 mt-2  md:h-96 w-full md:w-2/3 rounded'>
                <VideoPlayback />
