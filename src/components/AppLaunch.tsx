...
const AppLaunch: React.FC = () => {
    ...
    return (
        <div className='grid items-center justify-items-center my-0 md:my-10 '>
            <div className="flex flex-col items-center justify-center my-6 md:my-20 mx-auto md:w-2/3 p-2 md:p-0">

                <h2 className='font-semibold text-2xl md:text-4xl truncate'>About us!</h2>
                ...
                <Link href={"https://play.google.com/store/apps/dev?id=5352759552017891252"}> <Image className='m-6 w-28 hover:scale-110 translate-x-0 transition-all hover:shadow-lg' src={playstre} alt='playstore' /></Link>
